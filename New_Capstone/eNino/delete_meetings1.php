					                            ...
					                            <div id="contacts_container">
                                                        ...
                                                        <?php
                                                            ...
                                                            while($row=$result->fetch_assoc()){
                                                                ...
                                                                echo "<tr><td>{$row['date']}</td><td>{$row['topic']}</td><td>{$row['speaker']}</td> <td> <a onClick=\"javascript: return confirm('Are you sure you want to delete?');\" href='delete_meetings2.php?id={$row['meetings_id']}'>Delete</a> </td> </tr>";

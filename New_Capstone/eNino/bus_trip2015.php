...
<div class="container">
  ...
  <div class="dropdown-menu">
       <a class="dropdown-item" href="bus_trip.php">2016</a>
       <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="bus_trip2015.php">2015</a>
    <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="bus_trip2014.php">2014</a>
...
<br/>
 <?php
					          $sql="SELECT * FROM bus_trips WHERE trip_year=2015";
                            $result=$link->query($sql);
